...
$(function() {
    ...
    var latitude = -25.437056,
        longitude = -54.597403,
        map_zoom = 14;

    //google map custom marker icon - .png fallback for IE11
    var is_internetExplorer11 = navigator.userAgent.toLowerCase().indexOf('trident') > -1;
    var marker_url = (is_internetExplorer11) ? 'cdt_caenfis/images/cd-icon-location.png' : 'cdt_caenfis/images/cd-icon-location.svg';
    ...
    var map_options = {
            center: new google.maps.LatLng(-25.437056,-54.597403),
            zoom: map_zoom,
            panControl: false,
            zoomControl: false,
...
$(function() {
    $('.popup-gallery').magnificPopup({
        ...
        image: {
            tError: '<a href="../../cdt_caenfis/js/%url%">The image #%curr%</a> could not be loaded.',
            titleSrc: function(item) {
                return item.el.attr('title') + '<small>by caenfis</small>';
            }
        }
    });
